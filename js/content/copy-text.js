/**
 * 选中复制
 * 适用于 百度文库 道客巴巴 腾讯文档 豆丁网 无忧考网 学习啦 蓬勃范文 思否社区 力扣 知乎 语雀 等
 */
var css_248z$1 = ".__copy-button{align-items:center;background:#5a9cf8;border-radius:4px;color:#fff;cursor:pointer;display:flex;font-size:10px;padding: 4px 12px;justify-content:center;opacity:0;position:absolute;transition:opacity .3s;z-index:-1000;cursor: pointer;}";
...
var website$r = {
  ...
  init: function () {
    ...
    //   },
    // });
    fetch("https://res3.doc88.com/resources/js/modules/main-v2.min.js?v=2.56", {
      method: "GET",
